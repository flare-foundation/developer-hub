...
4. Add the Flare Testnet Coston2 to your MetaMask wallet. Go to the the [Coston2 Blockchain Explorer](https://coston2-explorer.flare.network), scroll down and click on **Add Flare Testnet Coston2**.
