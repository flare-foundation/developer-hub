---
slug: participate-in-flare-governance
title: Participate in Flare governance
authors: xaviartigas
tags: [flare, on chain governance]
---

An integral part of the [governance process](/docs/flare/on-chain-governance), voting is the way you influence decisions about how Flare and Songbird operate.
...
All changes to the Flare and Songbird networks are determined by the outcomes of votes on [Flare Improvement Proposals](/docs/flare/on-chain-governance#flare-improvement-proposals-(fips).
...
This block is called the vote count block.
...
You can wrap your tokens by using the [Flare Portal](https://portal.flare.network), as shown in the Getting Wrapped Tokens section below.
...
:::note
    ...
    For more information, see Getting Wrapped Tokens.
