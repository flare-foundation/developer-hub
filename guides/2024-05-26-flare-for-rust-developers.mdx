...
To fetch a contract's ABI, you can use Flarescan. Copy the Contract ABI from [here](https://flarescan.com/address/0xaD67FE66660Fb8dFE9d6b1b4240d8650e30F6019/contract/14/code#abi), and paste this into a file named `FlareContractRegistry.json` in the root of your project, i.e. same level as `Cargo.toml`.
