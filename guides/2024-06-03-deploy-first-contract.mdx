...
1. **Write:** Write a smart contract to define some logic - what data it can store, how the data can be modified, who can modify the data, and what other contracts it can call.
...
3. **Deploy:** Send the compiled smart contract to the blockchain. From that point forward, the contract code itself cannot be altered.

4. **Call functions:** When you call the functions defined in your contract, the network processes those functions and modifies the state of the blockchain accordingly.
...
4. Add the Flare Testnet Coston2 to your MetaMask wallet. Go to the the [Coston2 Blockchain Explorer](https://coston2-explorer.flare.network), scroll down and click on **Add Coston2**.
...
The contract has an address just like your wallet address. To see details about your deployed contract, copy the contract address from the list in Remix and search for it in the [Coston2 Blockchain Explorer](https://coston2-explorer.flare.network/).
