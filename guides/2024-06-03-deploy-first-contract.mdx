...
4. **Call functions:** When you call the functions that you defined in your contract, the network processes those functions and modifies the state of the blockchain accordingly.
...
4. Add the Flare Testnet Coston2 to your MetaMask wallet. Go to the the [Coston2 Explorer](https://coston2-explorer.flare.network), scroll down and click on **Add Coston2**.
