...
5. A MetaMask prompt will open asking you to approve adding the network. Click on **Approve**. You can ignore the warnings MetaMask raises here.
...
Next, read FTSOv2's [Getting Started](../docs/ftso/getting-started) guide to learn how to connect your smart contracts to Flare's enshrined oracle and retrieve onchain data that your contracts can act on.
