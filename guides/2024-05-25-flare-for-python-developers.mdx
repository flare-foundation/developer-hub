...
You need to connect to testnet or mainnet via an RPC, any RPC listed on the [Network Configuration](/network#configuration) page will work. For this guide, you can use the Ankr RPC.
...
- For testnet, you can use the testnet faucets on the [Network Configuration](/network#configuration) page to get some testnet C2FLR.
...
You can now run the `deploy_contract.py` script to deploy the contract. The contract address will be printed once the deployment is successful. You can check the contract address on a Flare Blockchain Explorer, linked on the [Network Configuration](/network#configuration) page.
