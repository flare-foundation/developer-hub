...
- Bridge data across blockchains using the State Connector
...
2. **Make attestation request**: Submit the hex-encoded request to the State Connector smart contract, which emits an event to notify attestation providers about your request.
