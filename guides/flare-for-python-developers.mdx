...
authors: [dineshpinto]
tags: [python, quickstart, web3py, py-solc-x]
---

import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

This guide is for developers who want to interact with Flare using Python. You can interact with Flare using [web3.py](https://web3py.readthedocs.io/en/stable/), a library featuring both synchronous and asynchronous interfaces for interacting with Ethereum-like chains. To compile a contract, you can use [py-solc-x](https://solcx.readthedocs.io/en/latest/), a Python wrapper around the Solidity compiler.
