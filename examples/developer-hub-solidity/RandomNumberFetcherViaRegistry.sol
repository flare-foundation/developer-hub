...
contract RandomNumberFetcher {
    ...
    function getRandomNumberViaRegistryName() public view returns(
        uint256 _randomNumber,
        bool _isSecureRandom,
        uint256 _randomTimestamp
    ) {
        // Get the Flare Contracts Registry smart contract
        IFlareContractRegistry flareContractRegistry = IFlareContractRegistry(0xaD67FE66660Fb8dFE9d6b1b4240d8650e30F6019);
        // Get the address of the Random Number V2 contract
        address randomNumberV2Address = flareContractRegistry.getContractAddressByName("RandomNumberV2");
        // Define the random number V2 interface
        RandomNumberV2Interface randomNumberV2 = RandomNumberV2Interface(randomNumberV2Address);
