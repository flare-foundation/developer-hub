...
slug: onboarding
title: Onboarding
description: Step-by-step guide for setting up compute instances for the Flare x Google Cloud Verifiable AI Hackathon.
...
3. **Check authenticate**
   ...
   List all accounts attached to gcloud CLI, you should see a active \* next to your account,
   double check that it is the same account as used for registration:
