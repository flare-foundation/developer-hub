...
:::note
User minting uses [FAssets minting](/fassets/minting) (`executeDirectMinting` on the AssetManager), not this function.
`reserveCollateral` supports the legacy collateral-reservation (CRT) Smart Accounts instruction path.
:::
