...
Use this to [detect whether an arbitrary Flare address is a smart account](/smart-accounts/guides/state-lookup-ts#checking-if-a-flare-address-is-a-smart-account).
:::
