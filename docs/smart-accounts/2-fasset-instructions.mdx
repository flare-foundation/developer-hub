...
>
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "img/smart-accounts/bytes-fxrp-collateral-reservation-light.png",
      ),
      dark: useBaseUrl(
        "img/smart-accounts/bytes-fxrp-collateral-reservation-dark.png",
      ),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    style={{ width: "100%" }}
    sources={{
      light: useBaseUrl("img/smart-accounts/bytes-fxrp-transfer-light.png"),
      dark: useBaseUrl("img/smart-accounts/bytes-fxrp-transfer-dark.png"),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    style={{ width: "100%" }}
    sources={{
      light: useBaseUrl("img/smart-accounts/bytes-fxrp-redeem-light.png"),
      dark: useBaseUrl("img/smart-accounts/bytes-fxrp-redeem-dark.png"),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "img/smart-accounts/bytes-firelight-collateral-reservation-and-deposit-light.png",
      ),
      dark: useBaseUrl(
        "img/smart-accounts/bytes-firelight-collateral-reservation-and-deposit-dark.png",
      ),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    style={{ width: "100%" }}
    sources={{
      light: useBaseUrl("img/smart-accounts/bytes-firelight-deposit-light.png"),
      dark: useBaseUrl("img/smart-accounts/bytes-firelight-deposit-dark.png"),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    style={{ width: "100%" }}
    sources={{
      light: useBaseUrl("img/smart-accounts/bytes-firelight-redeem-light.png"),
      dark: useBaseUrl("img/smart-accounts/bytes-firelight-redeem-dark.png"),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "img/smart-accounts/bytes-firelight-claim-withdraw-light.png",
      ),
      dark: useBaseUrl(
        "img/smart-accounts/bytes-firelight-claim-withdraw-dark.png",
      ),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "img/smart-accounts/bytes-firelight-request-redeem-light.png",
      ),
      dark: useBaseUrl(
        "img/smart-accounts/bytes-firelight-request-redeem-dark.png",
      ),
    }}
  />
</div>
...
>
  <ThemedImage
    ...
    style={{ width: "100%" }}
    sources={{
      light: useBaseUrl("img/smart-accounts/bytes-upshift-claim-light.png"),
      dark: useBaseUrl("img/smart-accounts/bytes-upshift-claim-dark.png"),
    }}
  />
</div>
