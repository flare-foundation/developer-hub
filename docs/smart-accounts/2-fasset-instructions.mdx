...
The commands of the `Firelight` type allow to interact with Firelight type vaults.
...
The commands of the `Upshift` type allow to interact with Upshift type vaults.
