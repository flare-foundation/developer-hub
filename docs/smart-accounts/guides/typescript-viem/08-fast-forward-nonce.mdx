...
This guide walks through advancing a personal account's **memo-instruction nonce** when it is stuck after a partial or abandoned [direct mint](/fassets/minting) flow.
