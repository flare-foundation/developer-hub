...
For direct-minting errors, see [Smart Account Path](/fassets/troubleshooting/direct-minting-troubleshooting#smart-account-path) in the FAssets troubleshooting guide.
