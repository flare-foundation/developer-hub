...
- **Minting fee**: A percentage of the received amount (in BIPS), with a minimum floor.
  ...
  See [Direct Minting Troubleshooting](/fassets/troubleshooting/direct-minting-troubleshooting#irreversible-failures) for prevention steps.
...
For delay retry steps and cap failures, see [Direct Minting Troubleshooting — Delays](/fassets/troubleshooting/direct-minting-troubleshooting#delays).
:::
...
- Troubleshoot common direct minting failures in [Direct Minting Troubleshooting](/fassets/troubleshooting/direct-minting-troubleshooting).
