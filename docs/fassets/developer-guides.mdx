...
See also the [FXRP overview page](/fassets/fxrp) for more FXRP resources.
...
- Explore [FXRP](/fassets/fxrp) and discover what you can do with the FAsset representation of XRP.
- Read the [FAssets overview](/fassets/overview) to understand how the system works.
- Learn how to earn yield on your FXRP with [Firelight](/fassets/fxrp#firelight) vault.
