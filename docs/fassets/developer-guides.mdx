...
<div className="row">
  ...
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      ...
      item={{
        type: "link",
        label: "Mint FXRP with Tag",
        href: "/fassets/developer-guides/fassets-mint-tag",
        docId: "fassets/developer-guides/fassets-mint-tag",
      }}
    />
  </div>
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      ...
      item={{
        type: "link",
        label: "Check Minting Limits",
        href: "/fassets/developer-guides/fassets-mint-limits",
        docId: "fassets/developer-guides/fassets-mint-limits",
      }}
    />
  </div>
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      ...
      item={{
        ...
        href: "/fassets/developer-guides/fassets-mint-tag-transfer",
        docId: "fassets/developer-guides/fassets-mint-tag-transfer",
      }}
    />
  </div>
</div>
...
Common failures, error references, and recovery steps for minting and redemption.
...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      ...
      item={{
        type: "link",
        label: "Minting Troubleshooting",
        href: "/fassets/troubleshooting/minting-troubleshooting",
        docId: "fassets/troubleshooting/minting-troubleshooting",
      }}
    />
  </div>
</div>
