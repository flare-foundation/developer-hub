...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      ...
      item={{
        type: "link",
        label: "Direct Minting Troubleshooting",
        href: "/fassets/troubleshooting/direct-minting-troubleshooting",
        docId: "fassets/troubleshooting/direct-minting-troubleshooting",
      }}
    />
  </div>
</div>
