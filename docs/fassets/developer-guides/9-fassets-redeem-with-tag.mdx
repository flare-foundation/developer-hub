...
4. Set `REDEMPTION_DESTINATION_TAG` to the XRPL destination tag the agent must include on the redemption payment.
   ...
   See [minting with tag](/fassets/minting#minting-tag-manager) for more details or check out the [minting with tag example](/fassets/developer-guides/fassets-mint-tag) on how to reserve a tag.
...
- Mint without a tag using [memo-based minting](/fassets/developer-guides/fassets-mint) or [minting with tag](/fassets/developer-guides/fassets-mint-tag).
