...
description: Read live minting rate limits and pre-flight a mint against hourly, daily, and large-mint delays.
...
The complete runnable example is available in the [flare-viem-starter](https://github.com/flare-foundation/flare-viem-starter/blob/main/src/fassets/minting-limits.ts) repository.
...
<CodeBlock language="typescript" title="src/fassets/minting-limits.ts">
