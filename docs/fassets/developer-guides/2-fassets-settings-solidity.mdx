...
This guide will show you how to fetch FAsset [lot size](/fassets/redemption#lots) for FXRP using the Solidity smart contract on the Flare network.
...
{/* prettier-ignore */}
<RemixEmbed fileName="FAssetsAssetManagerSettingsLotSize.sol">Open in Remix</RemixEmbed>
<br></br>
