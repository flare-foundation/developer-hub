...
Tag-specific mistakes — wrong reservation fee, non-owner recipient changes, executor cooldowns, and recipient reset on transfer — are covered in [Minting Tag Manager Pitfalls](/fassets/troubleshooting/direct-minting-troubleshooting#minting-tag-manager-pitfalls).
