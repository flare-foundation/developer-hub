...
- **Delay and cap failures** — see [Delays](/fassets/troubleshooting/direct-minting-troubleshooting#delays) in the Direct Minting Troubleshooting guide for retry steps when rate limits bind.
