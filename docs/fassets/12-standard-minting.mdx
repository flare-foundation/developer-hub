---
title: Standard Minting (Archived)
description: Archived documentation for the collateral-reservation minting flow in FAssets.
keywords: [fassets, xrp, bitcoin, dogecoin, flare-network, archived]
slug: standard-minting
unlisted: true
---
...
:::warning[Archived]
This page documents the legacy **collateral-reservation** minting flow.
For current FXRP minting, see [Minting](/fassets/minting).
:::
...
The CRT includes:
    ...
    - The amount to mint, which must be a positive integer of [lots](/fassets/standard-minting#lots).
...
For the current minting path, see [Minting](/fassets/minting) and [Mint FXRP](/fassets/developer-guides/fassets-mint).
