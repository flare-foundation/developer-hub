...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/fassets/flare_fassets_core_vault_architecture_light.svg"),
    dark: useBaseUrl("img/fassets/flare_fassets_core_vault_architecture_dark.svg"),
  }}
/>
