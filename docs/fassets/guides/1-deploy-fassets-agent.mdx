...
1. Navigate with the Songbird block explorer to the [`AgentOwnerRegistry`](/fassets/reference#deployed-contracts) contract and open the Read Contract tab.
...
1. Navigate with the Songbird block explorer to the [`AgentOwnerRegistry`](/fassets/reference#deployed-contracts) contract and open the Write Contract tab.
