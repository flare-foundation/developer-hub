...
- **USDX Tokens:** Agents must deposit a USDX as vault collateral tokens into the `owner.USDX.address`.
...
|               `FXRP` | [`0xbEf69D030bfd0514A26ffa00A40567263c878990`](https://songbird-explorer.flare.network/address/0xbEf69D030bfd0514A26ffa00A40567263c878990) | The FAsset-wrapped TestXRP token, ready for use on Songbird.                                                                             |
|               `FBTC` | [`0xAF7EB55cC12651e6681d08b9df31aE1dD0C9e857`](https://songbird-explorer.flare.network/address/0xAF7EB55cC12651e6681d08b9df31aE1dD0C9e857) | The FAsset-wrapped TestBTC token, ready for use on Songbird.                                                                             |
|              `FDOGE` | [`0x99594c18fA6E345cc8ef31cCF1bb1094F2726b26`](https://songbird-explorer.flare.network/address/0x99594c18fA6E345cc8ef31cCF1bb1094F2726b26) | The FAsset-wrapped DOGE token, ready for use on Songbird.                                                                                |
...
2. Switch to `songbird-release` branch:

   ```bash
   git checkout songbird-release
   ```
...
6. Get the latest docker containers from the registry:
