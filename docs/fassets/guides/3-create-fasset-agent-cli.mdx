...
title: Create FAssets Agent Using Command Line Interface
description: Learn how to set up and manage the FAssets agent using the command line interface
...
After you start the Docker services, access the command line of the FAssets agent runing the following command:
...
To make your newly created agent public, it must hold enough [collateral](/fasset/collateral) to mint one lot.
