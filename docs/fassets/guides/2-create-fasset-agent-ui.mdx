...
4. Update your settings.
   These settings always have [time locks](/fassets/operational-parameters#time-locks) to minimize abuse.
...
To be activated, a vault must contain at least 1 [lot](/fassets/minting#lots) for minting.

To activate a vault: 1. On the dashboard, locate the vault you want to activate, and click the three dots icon in the **Actions** column.
The **Vault options** menu is displayed. 2. In the **Agent Vault Operations** section, click **Activate Vault (Enter)**.
The **Activate Vault** window is displayed. 3. Read the message in the **Activate Vault** window about minting requirements, ensure your vault contains at least 1 lot to meet the requirement, and then click **Confirm** to activate the vault.
