...
- **FDC health verification**:
  ...
  - Query the FDC verifier with: `GET http://localhost:9800/verifier/{chain}/health`
...
- For finalization Verification, your log should contain:
  ...
  ⚠️ **Alert Tip:** Set an alert if there is no `Relaying finished ... message` for 5-10 minutes (note that protocol 200 is FDC)
