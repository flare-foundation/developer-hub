...
The FDC Client deployment is now part of the [`flare-systems-deployment`](https://github.com/flare-foundation/flare-systems-deployment) repository, which is also used for deploying FTSO v2. Previously, this was managed under the `ftso-v2-provider-deployment` repository.
