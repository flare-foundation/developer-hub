...
After the introduction of [minimal conditions](/network/fsp/rewarding#minimal-conditions), a Flare Entity needs to be both **available** and **performant** across all Flare protocols in order to be eligible for rewards.
