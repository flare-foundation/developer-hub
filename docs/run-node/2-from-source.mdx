...
| **[cURL](https://curl.se/download.html)**          | `latest`    |
...
Start by fetching the bootstrap IP and node ID from the network:
...
The following command is simplest way to quickly get your node up and running. The next section explains the parameters used here, along with additional parameters you may wish to configure.
