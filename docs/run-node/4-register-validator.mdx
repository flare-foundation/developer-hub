...
Professional validators are expected to cease operations unless they provide their own stake. The Flare Foundation might delegate stake to KYC-verified FTSO data providers to help initiate the system. This process, known as stake boosting, will run for a limited time. Staked funds can earn [FlareDrops](https://flare.network/news/flaredrop-guide) and participate in governance but not earn [FTSO](https://flare.network/products/flare-time-series-oracle) delegation rewards.
