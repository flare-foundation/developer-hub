...
1. Ensure you completed the optional [Step 6](/run-node/using-docker#using-docker-compose) of copying your staking keys to a persistent directory outside the default location.
