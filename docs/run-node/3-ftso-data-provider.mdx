...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("/img/run-node-ftso-data-provider/ftso_provider_architecture_light.svg"),
    dark: useBaseUrl("/img/run-node-ftso-data-provider/ftso_provider_architecture_dark.svg"),
  }}
/>
