...
- [`registerPublicKey`](/network/fsp/solidity-reference/IEntityManager#registerpublickey)
...
When registering the sortition key using the explorer, you will need to manually create a signature and input this into the `_verificationData` parameter, as described [here](/network/fsp/solidity-reference/IEntityManager#registerpublickey).
