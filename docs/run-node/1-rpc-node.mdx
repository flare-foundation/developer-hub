...
<Tabs groupId="network" block>
  ...
  <TabItem value="songbird" label="Songbird Canary-Network">
    ...
    Use the Docker image at [go-flare](https://hub.docker.com/layers/flarefoundation/go-flare/v0.6.6-songbird/images/sha256-86b90c8aeb91d5fe6efaeebf71ddd028405ff99bf4ed7c31e992dd170f063363?context=explore). The **Overview** tab in the repository linked explains the configurable parameters.
