...
- **Staking** reward information is available at [flare-foundation/reward-scripts](https://github.com/flare-foundation/reward-scripts/tree/main/generated-files/validator-rewards). Updated every 4 reward epochs (14 days), with epochs starting on Monday and Thursday.
...
- **Validator Staking Rewards:**
  ...
  - Typically released every 4 reward epochs (approx. every 14 days).
