---
<<<<<<<< HEAD:docs/run-node/3-flare-entity.mdx
sidebar_position: 3
title: Flare Entity
...
========
sidebar_position: 8
title: Flare Systems Protocol Provider
slug: fsp-provider
description: Provide data for Flare's enshrined FTSO and FDC protocols.
>>>>>>>> 0aa0ddc (FLR-1535 Updated running a node documentation):docs/run-node/8-flare-systems-provider.mdx
---
