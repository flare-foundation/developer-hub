...
>
  <CustomCard
    ...
    href="/pdf/whitepapers/20260706-FlareConfidentialCompute.pdf"
    description="Introduces Flare Confidential Compute (FCC), smart contract infrastructure that lets users issue on-chain instructions to Trusted Execution Environments (TEEs), enabling Protocol Managed Wallets, Flare Compute Extensions, and FDC2 for improved Web2 and Web3 interoperability."
    date="Jul 6, 2026"
  />
  <CustomCard
