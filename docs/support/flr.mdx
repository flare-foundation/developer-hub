...
FLR serves several key function in Flare:

- **Network Security**: Staking to [validator nodes](/run-node/validator-node) to provide network security through a [Proof-of-Stake (PoS) consensus](/network/overview#consensus).
...
- **Can delegate**: The entity can delegate tokens to the [Flare Time Series Oracle](/ftso/overview) to earn standard inflationary rewards.
- **Can claim**: The entity can wrap tokens to claim a portion of the [FlareDrop](/network/guides/manage-flaredrops).
- **Can vote**: The entity can use its tokens to participate in [governance](/network/fsp/governance) by voting on [Flare Improvement Proposals (FIPs)](/network/fsp/governance#flare-improvement-proposals-fips).
