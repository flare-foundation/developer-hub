...
You can get Coston2 testnet `C2FLR` tokens the [Coston2 Faucet](https://faucet.flare.network/coston2) and Coston testnet `CFLR` tokens from the [Coston Faucet](https://faucet.flare.network/coston). To understand the difference between Coston and Coston2, see [Network Configuration](../flare/configuration).
...
Join the rapidly growing community of developers on Flare.
