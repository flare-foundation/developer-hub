...
import FtsoArchLight from "/static/img/run-a-node-ftso-data-provider/ftso_architecture_light.jpg";
import FtsoArchDark from "/static/img/run-a-node-ftso-data-provider/ftso_architecture_dark.jpg";
