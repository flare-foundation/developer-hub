---
sidebar_position: 5
slug: fassets-liquidator
title: FAssets Liquidator
description: Contribute to the stability and efficiency of FAssets.
---
...
<details>
<summary>Maximize uptime by setting up the liquidator as a `systemd` service.</summary>
...
2. Modify the the following variables in `liquidator-bot.service`:
