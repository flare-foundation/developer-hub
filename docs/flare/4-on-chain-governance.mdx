...
If you are already familiar with Flare's governance and just need to know how to cast your vote through the Flare Portal, see the guide on how to [Participate in Flare governance](../../guides/participate-in-flare-governance).

## Flare Improvement Proposals
...
- **Vote block selection period**: The [vote count block](#vote-count-block) is selected at a random time during this period. The duration of this period is also random.
...
- [Participate in Flare governance](../../guides/participate-in-flare-governance)
