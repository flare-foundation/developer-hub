...
- [Learn how to use FTSOv2](../ftso/overview) - Leverage the latest upgrades to Flare Time Series Oracle, where feeds now update every ≈1.8 seconds on Flare. This is 90x faster than FTSOv1.
