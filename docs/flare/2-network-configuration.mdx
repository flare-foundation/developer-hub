...
Configuration for all Flare networks, along with RPCs, blockchain explorers, and faucets:
...
<Tabs block>
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    | Blockchain Explorers| [Coston2 Explorer](https://coston2-explorer.flare.network) |
    ...
    | Blockchain Explorers| [Songbird Explorer](https://songbird-explorer.flare.network)                                                   |
    | Faucets             | -                                                          |
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    | Blockchain Explorers| [Coston Explorer](https://coston-explorer.flare.network)   |
