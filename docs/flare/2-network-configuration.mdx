...
- **Flare Testnet Coston2.** Flare's testnet, test your applications without spending real money. This should be your first choice when developing applications.

- **Songbird Canary-Network.** Experimental proving ground for Flare, test your applications in a real-world environment.

- **Songbird Testnet Coston.** Songbird's testnet.

The most common development tracks are:

- **Flare Testnet Coston2 → Flare Mainnet** (Recommended for application developers)

- **Songbird Testnet Coston → Songbird Canary-Network → Flare Mainnet** (Required for all protocol level changes)
...
Several browser and mobile app based wallets such as MetaMask, Rabby and Bifrost support Flare. Find some options that might be right for you on the [Flare Ecosystem](https://flare.network/wallets/) page.
