...
You can explore the API through their Swagger interface at `https://fdc-verifiers-testnet.flare.network/verifier/eth/api-doc`.
...
{/* prettier-ignore */}
<RemixEmbed fileName="FDCTransferEventListener.sol">Open in Remix</RemixEmbed>
<br></br>
