...
:::tip[Need a new attestation type?]

FDC is highly extensible, define custom verification logic and learn how to [create a new attestation type](/fdc/guides/create-attestation-type).
