...
- Collect: Users send their requests to the Data Connector contract, which emits events. Attestation providers gather these requests, assign them to a voting
...
<details>
    ...
    */
     ...
     * @param status  [Success status](/specs/attestations/external-chains/transactions.md#transaction-success-status) of the transaction: 0 - success, 1 - failed by sender's fault,x  2 - failed by receiver's fault.
     */
    struct ResponseBody {
    uint64 blockNumber;
