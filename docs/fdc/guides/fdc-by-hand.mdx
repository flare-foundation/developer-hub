...
import VotingRoundIdCalculator from "@site/src/features/FDC/VotingRoundIdCalculator";
import ToHexConverter from "@site/src/features/FDC/ToHexConverter";
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-authorize.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-authorize.png"),
  }}
/>
...
>
  ...
  >
    <ThemedImage
      ...
      sources={{
        light: useBaseUrl(
          "img/docs/fdc/fdc-by-hand/verifier-authorization.png",
        ),
        dark: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-authorization.png"),
      }}
    />
  </div>
  <div
  ...
  >
    <ThemedImage
      ...
      sources={{
        light: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-authorized.png"),
        dark: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-authorized.png"),
      }}
    />
  </div>
</div>
...
>
  ...
  >
    <ThemedImage
      ...
      sources={{
        light: useBaseUrl(
          "img/docs/fdc/fdc-by-hand/verifier-address-validity-prepare-request-expanded.png",
        ),
        dark: useBaseUrl(
          "img/docs/fdc/fdc-by-hand/verifier-address-validity-prepare-request-expanded.png",
        ),
  ...
  >
    <ThemedImage
      ...
      sources={{
        light: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-try-it-out.png"),
        dark: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-try-it-out.png"),
      }}
    />
  </div>
</div>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/verifier-executed-with-data.png",
    ),
    dark: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/verifier-executed-with-data.png",
    ),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-response.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/verifier-response.png"),
  }}
/>
...
We can use [Flare Explorer](https://coston2-explorer.flare.network/address/0x48aC463d7975828989331F4De43341627b9c5f1D).

First, we must navigate to the `Contract` tab on the explorer, and then to [Write contract](https://coston2-explorer.flare.network/address/0x48aC463d7975828989331F4De43341627b9c5f1D?tab=write_contract).
...
<ThemedImage
  alt="FdcHub contract "
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/fdc-hub.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/fdc-hub.png"),
  }}
/>

The request fee can be queried from the `FdcRequestFeeConfigurations` contract, through its [`getRequestFee` function](https://coston2-explorer.flare.network/address/0x191a1282Ac700edE65c5B0AaF313BAcC3eA7fC7e?tab=read_contract).
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/fdc-request-fee-configurations.png",
    ),
    dark: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/fdc-request-fee-configurations.png",
    ),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/da-proof-by-request-round-expanded.png",
    ),
    dark: useBaseUrl(
      "img/docs/fdc/fdc-by-hand/da-proof-by-request-round-expanded.png",
    ),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/da-try-it-out.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/da-try-it-out.png"),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/da-response.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/da-response.png"),
  }}
/>
...
We do so through the [`FdcVerification` contract](https://coston2-explorer.flare.network/address/0x075bf301fF07C4920e5261f93a0609640F53487D?tab=read_write_contract).

<ThemedImage
  alt="FdcVerification contract"
  sources={{
    light: useBaseUrl("img/docs/fdc/fdc-by-hand/fdc-verification.png"),
    dark: useBaseUrl("img/docs/fdc/fdc-by-hand/fdc-verification.png"),
  }}
/>
