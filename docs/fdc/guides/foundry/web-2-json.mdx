...
Because of the `console.log` commands it will produce JSON strings that represent valid requests; we can then pass this to the [interactive verifier](https://jq-verifier-test.flare.rocks/api-doc/JsonApi/prepareRequest) to check the response.
