...
You can learn more about it in the official [specification repo](/fdc/attestation-types/deprecated-json-api).
...
- [JsonApi Specification](/fdc/attestation-types/deprecated-json-api)
