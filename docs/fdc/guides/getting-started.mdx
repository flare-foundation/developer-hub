...
This guide focuses on the [**EVMTransaction attestation type**](/fdc/attestation-types/evm-transaction), an attestation type designed to prove and relay data about a transaction that happened on an external EVM chain.
