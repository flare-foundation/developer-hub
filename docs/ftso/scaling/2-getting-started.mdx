...
import QueryDAandPushOnchain from "!!raw-loader!/examples/developer-hub-javascript/query_da_and_push_onchain.ts";
import QueryDataProvider from "!!raw-loader!/examples/developer-hub-javascript/query_data_provider.ts";
...
:::note[Efficiency optimizations in Scaling]
...
<CodeBlock language="typescript" title="query_da_and_push_onchain.ts">
...
<CodeBlock language="typescript" title="query_data_provider.ts">
  {QueryDataProvider}
</CodeBlock>
