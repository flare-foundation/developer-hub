...
FTSOv2 is currently in alpha testing on Flare Testnet Coston2, Songbird Canary-Network and Songbird Testnet Coston.
...
- **Scalable.** With the introduction of Scaling, FTSOv2 supports up to 1000 feeds across various asset classes including equities, commodities, and cryptocurrencies, and offers access to 2 weeks of historical data.

- **Decentralized.** Every feed is supported by around 100 independent data providers, who are selected by Flare users through their delegated stake, imposing a strict economic cost for misbehavior.
