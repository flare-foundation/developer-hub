---
title: FTSOv2 Cookbook
tags: [intermediate, ftso, solidity]
slug: ftsov2-cookbook
description: Cookbook for FTSOv2.
keywords:
  [
    solidity,
    ftso,
...
The FTSOv2 Cookbook is a developer resource that provides examples and references for building applications using FTSOv2. Each example and reference will focus on specific aspects of FTSOv2 development while providing additional details and usage examples.
