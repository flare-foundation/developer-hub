...
:::info
Before reading this guide, make sure you understand the [FTSOv2 Architecture](/docs/ftso/overview#architecture), in particular the [Volatility Incentive Mechanism](/docs/ftso/overview#volatility-incentive-mechanism).
:::

## JavaScript

This example shows two ways, one using [web3.js](https://github.com/web3/web3.js) and the other using [ethers.js](https://github.com/ethers-io/ethers.js/), to make an FTSOv2 Volatility Incentive offer on Songbird Testnet Coston.
...
This example uses [web3.py](https://github.com/ethereum/web3.py) to make an FTSOv2 Volatility Incentive offer on Songbird Testnet Coston.
