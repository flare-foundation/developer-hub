...
<Tabs block>
  <TabItem value="web3js" label="web3.js" default>
    This example uses [web3.js](https://github.com/web3/web3.js) and [Flare Periphery Contract Artifacts](https://www.npmjs.com/package/@flarenetwork/flare-periphery-contracts) to retrieve FTSOv2 feed configurations on Flare Testnet Coston2.
