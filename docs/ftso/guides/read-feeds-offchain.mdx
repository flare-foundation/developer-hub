...
import Button from "../../../src/css/button.module.css";
...
<Tabs block>
    <TabItem value="web3js" label="web3.js" default>
        ...
        <a href=" " type="button" class={Button.primary}>
            {"Run this Web3.js example"}
        </a>
    </TabItem>
