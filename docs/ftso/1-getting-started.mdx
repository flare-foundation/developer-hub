...
:::info
If you have not already configured your MetaMask wallet to support Coston2 and funded it with testnet `C2FLR`, learn how to [deploy your first smart contract](../../guides/deploy-first-contract) before you start the next step.
