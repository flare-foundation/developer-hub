...
- The contract initializes the `ftsoV2` variable with the address of the FTSOv2 contract on Flare Testnet Coston2.
...
{/* prettier-ignore */}
1. [Open the contract in Remix](https://remix.ethereum.org/#version=soljson-v0.8.19+commit.7dd6d404.js&optimize=true&runs=200&gist=d6181b71e7932701efbc6c3c78898f5a)
