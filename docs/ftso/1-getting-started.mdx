...
[Build your first FTSOv2 app](./guides/build-first-app) using Foundry, or [read feeds offchain](./guides/read-feeds-offchain) in languages like JavaScript, Python, Rust, and Go.
