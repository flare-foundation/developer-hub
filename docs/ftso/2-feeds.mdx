...
FTSOv2's block-latency interface supports a subset of feeds, updating every ≈1.8 seconds on Flare. You can request a new feed by raising a [New Feed Request Issue](https://github.com/flare-foundation/developer-hub/issues/new/choose) on GitHub.
