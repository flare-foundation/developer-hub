...
- [Participate in Flare governance](../../blog/participate-in-flare-governance) - Vote on Flare Improvement Proposals (FIPs) to dictate the future of Flare
...
- [Contribute to the Flare codebase](https://github.com/flare-foundation) - Help build the future of Flare by contributing to the open-source codebase
