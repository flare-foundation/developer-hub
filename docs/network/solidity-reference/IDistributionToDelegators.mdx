...
Sourced from `IDistributionToDelegators.sol` on [GitHub](https://github.com/flare-foundation/flare-solidity-periphery-package-mirror/blob/master/flare/IDistributionToDelegators.sol).
