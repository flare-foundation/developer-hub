...
Sourced from `IFlareContractRegistry.sol` on [GitHub](https://github.com/flare-foundation/flare-solidity-periphery-package-mirror/blob/master/flare/IFlareContractRegistry.sol).
