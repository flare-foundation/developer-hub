...
import ChainIdCoston2 from "!!raw-loader!/code_examples/developer-hub-go/coston2/chain_id.go";
import ChainIdFlare from "!!raw-loader!/code_examples/developer-hub-go/flare/chain_id.go";
import MakeQueryCoston2 from "!!raw-loader!/code_examples/developer-hub-go/coston2/make_query.go";
import MakeQueryFlare from "!!raw-loader!/code_examples/developer-hub-go/flare/make_query.go";
import CreateAccount from "!!raw-loader!/code_examples/developer-hub-go/create_account.go";
import DeployContractCoston2 from "!!raw-loader!/code_examples/developer-hub-go/coston2/deploy_contract.go";
import DeployContractFlare from "!!raw-loader!/code_examples/developer-hub-go/flare/deploy_contract.go";
...
Learn how to interact with the Flare Time-Series Oracle [using Go](/ftso/guides/read-feeds-offchain).
