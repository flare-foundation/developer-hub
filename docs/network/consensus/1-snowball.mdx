...
In the Go implementation from the [snow/consensus/snowball](https://github.com/flare-foundation/go-flare/tree/main/avalanchego/snow/consensus/snowball) submodule, the Snowflake and Snowball protocols share a common interface.
...
Next up we will see how Snowman optimizes the consensus algorithm further, by implementing a different tree-like structure for blocks at different heights.
