...
<Tabs block groupId="network">
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    |                 RPCs | [Ankr](https://www.ankr.com/rpc/flare/), [Thirdweb](https://14.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/14)                              |
    | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    |                 RPCs | [Ankr](https://www.ankr.com/rpc/flare/), [Thirdweb](https://114.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/114) |
    | :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
