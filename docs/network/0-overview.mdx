...
Developer tools for Flare built by the community including RPCs, bridges, indexers, wallet SDKs, and more.
...
- **Consensus mechanism:** Snowman++ (from [Avalanche](https://docs.avax.network)) offers a high-throughput, totally ordered consensus mechanism alongside a leader protocol to minimize MEV. Learn more on the [Consensus](/network/consensus) page.
...
Additional info: [Brand assets](https://flare.network/media/), [go-flare source](https://github.com/flare-foundation/go-flare)
