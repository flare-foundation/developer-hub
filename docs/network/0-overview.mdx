...
<Tabs block>
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    **Private RPC:**
    ...
    ```plaintext
    https://flare-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ```
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    **Private RPC:**
    ...
    ```plaintext
    https://coston2-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ```
    ...
    **Private RPC:**
    ...
    ```plaintext
    https://songbird-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ```
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    **Private RPC:**
    ...
    ```plaintext
    https://coston-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ```
