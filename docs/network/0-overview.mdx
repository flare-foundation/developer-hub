...
<Tabs block groupId="network">
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    | **Blockchain Explorers** | [`https://mainnet.flarescan.com`](https://mainnet.flarescan.com) <br/> [`https://flare-explorer.flare.network`](https://flare-explorer.flare.network)|
    | **Faucet**               | -                                                                                                                                                    |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    | **Faucet**                | [Coston2 Faucet](https://faucet.flare.network/coston2)                                                                                                                    |
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    | **Faucet**               | [Coston Faucet](https://faucet.flare.network/coston)                                                                                                                      |
...
<YoutubeEmbed embedLink="GwY_BhEpBG8?si=5jY4dq8d1Cv8YoYX"></YoutubeEmbed>
