  ...
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    <Tabs>
      <TabItem value="curl" label="curl" default>
        ...
        ```bash
        curl https://flare-api.flare.network/ext/C/rpc -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"REPLACE_ME_WITH_ACTUAL_METHOD","params":[],"id":1}'
        ```
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    <Tabs>
      <TabItem value="curl" label="curl" default>
        ...
        ```bash
        curl https://coston2-api.flare.network/ext/C/rpc -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"REPLACE_ME_WITH_ACTUAL_METHOD","params":[],"id":1}'
        ```
    ...
    <Tabs>
      <TabItem value="curl" label="curl" default>
        ...
        ```bash
        curl https://songbird-api.flare.network/ext/C/rpc -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"REPLACE_ME_WITH_ACTUAL_METHOD","params":[],"id":1}'
        ```
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    <Tabs>
      <TabItem value="curl" label="curl" default>
        ...
        ```bash
        curl https://coston-api.flare.network/ext/C/rpc -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"REPLACE_ME_WITH_ACTUAL_METHOD","params":[],"id":1}'
        ```
...
<Tabs block groupId="network">
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    |                 RPCs | [Ankr](https://rpc.ankr.com/flare), [Thirdweb](https://14.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/14)                              |
    | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    |             Bridging | [LayerZero V2](https://docs.layerzero.network/v2/developers/evm/technical-reference/deployed-contracts#flare), [Stargate V2](https://stargateprotocol.gitbook.io/stargate/v/v2-developer-docs/technical-reference/mainnet-contracts#flare) ([OFTs](https://stargateprotocol.gitbook.io/stargate/v/v2-developer-docs/technical-reference/v2-supported-networks-and-assets#flare)) |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    |                 RPCs | [Ankr](https://rpc.ankr.com/flare_coston2), [Thirdweb](https://114.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/114) |
    | :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
    ...
    |                 RPCs | [Ankr](https://rpc.ankr.com/flare_songbird), [Thirdweb](https://19.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/19)                        |
    | :------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    |             Bridging | -                                                                                                                                                                           |
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    |                 RPCs | [Ankr](https://rpc.ankr.com/flare_coston), [Thirdweb](https://16.rpc.thirdweb.com), [ChainList<IconExternalLink/>](https://ChainList.org/chain/16) |
    | :------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- |
    |             Bridging | -                                                                                                                                                  |
    |             Indexers | -                                                                                                                                                  |
    |          OAuth Login | [Web3Auth](https://web3auth.io/docs/connect-blockchain/evm/songbird/)                                                                              |
