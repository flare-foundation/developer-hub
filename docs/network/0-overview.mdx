...
<Tabs block groupId="network">
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    |              Faucets | -                                                                                                                                                                        |
    |  Bootstrapping nodes | `https://flare.flare.network` <br></br> `https://flare-bootstrap-1.staking.production.figment.io` <br></br> `https://flare.senseinode.com`                               |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    |  Bootstrapping nodes | `https://coston2.flare.network`                                                                                                                                              |
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    |  Bootstrapping nodes | `https://coston.flare.network`                                                                                                                                            |
