...
<Tabs block groupId="network">
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    | :--------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------- |
    | **FDC Verifier (EVM)**       | [`https://fdc-verifiers-mainnet.flare.network/verifier/eth/api-doc`](https://fdc-verifiers-mainnet.flare.network/verifier/eth/api-doc)               |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    | :--------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | **FDC Verifier (EVM)**       | [`https://fdc-verifiers-testnet.flare.network/verifier/eth/api-doc`](https://fdc-verifiers-testnet.flare.network/verifier/eth/api-doc)                             |
