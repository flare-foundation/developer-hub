...
<details>
<summary>Using Flare API RPCs.</summary>
...
<Tabs block>
  <TabItem value="flare" label="Flare Mainnet" default>
    ...
    | **Private**  | `https://flare-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx`  |
  ...
  <TabItem value="coston2" label="Flare Testnet Coston2">
    ...
    |              | **RPC URL**                                                                       |
    | :----------- | :-------------------------------------------------------------------------------- |
    | **Public**   | `https://coston2-api.flare.network/ext/bc/C/rpc`                                  |
    | **Private**  | `https://coston2-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx` |
    ...
    |              | **RPC URL**                                                                        |
    | :----------- | :--------------------------------------------------------------------------------- |
    | **Public**   | `https://songbird-api.flare.network/ext/bc/C/rpc`                                  |
    | **Private**  | `https://songbird-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx` |
  ...
  <TabItem value="coston" label="Songbird Testnet Coston">
    ...
    |              | **RPC URL**                                                                      |
    | :----------- | :------------------------------------------------------------------------------- |
    | **Public**   | `https://coston-api.flare.network/ext/bc/C/rpc`                                  |
    | **Private**  | `https://coston-api.flare.network/ext/bc/C/rpc?x-apikey=xxxxxxxx-xxxx-xxxx-xxxx` |

  </TabItem>

</Tabs>

Learn how to query RPCs using [JavaScript](/network/guides/flare-for-javascript-developers#usage), [Python](/network/guides/flare-for-python-developers#usage), [Rust](/network/guides/flare-for-rust-developers#usage) and [Go](/network/guides/flare-for-go-developers#usage).
