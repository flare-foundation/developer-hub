...
While Snowman enforces linearity, non-finalized blocks can be temporarily organized into a Directed Acyclic Graph (DAG) structure, which could simply be due to network delays for instance.
