...
1.  **Pragma Directive:** The `pragma solidity <0.9.0;` statement specifies the version of the Solidity compiler the contract should use. In this case, the contract is compatible with any version of Solidity below 0.9.0.
...
{/* prettier-ignore */}
1. <Remix href="https://remix.ethereum.org/#version=builtin&optimize=false&runs=200&gist=c05ca2bc30aba872d584bb56578a893f">Open contract in Remix</Remix>
...
4. Expand the **Advanced Configurations** section and set the **EVM Version** to `london`.
