...
import FlareCards from "@site/src/components/FlareCards";

Start building smart contracts and applications on Flare with our quickstart guides. Choose the tools that work best for your development workflow.

## Get a wallet

To interact with the Flare network, you'll need a compatible wallet. Select from one of the options below:
...
<FlareCards
  ...
  cards={[
    {
      title: "MetaMask",
      icon: "/img/getting-started/MetaMask-icon-fox.svg",
      description:
        "Popular browser extension wallet for accessing Ethereum-compatible blockchains",
      link: "https://metamask.io/download/",
      external: true,
    },
    {
      title: "Rabby",
      icon: "/img/getting-started/rabby-logo.svg",
      description:
        "Desktop wallet optimized for DeFi users with enhanced security features",
      link: "https://rabby.io/",
      external: true,
    },
  ]}
...
Choose your preferred development environment to deploy your first smart contract on Flare:
...
<FlareCards
  ...
  cards={[
    {
      title: "Foundry",
      icon: "/img/getting-started/foundry-logo.png",
      description: "Deploy Smart Contract on Flare using Foundry",
      link: "/network/guides/hardhat-foundry-starter-kit#foundry",
    },
    {
      title: "Hardhat",
      icon: "/img/getting-started/hardhat-logo.svg",
      description: "Deploy Smart Contract on Flare using Hardhat",
      link: "/network/guides/hardhat-foundry-starter-kit#hardhat",
    },
    {
      title: "Remix",
      icon: "/img/getting-started/remix-logo.png",
      description: "Deploy Smart Contract on Flare using Remix",
      link: "/network/getting-started#steps",
    },
  ]}
/>
...
After deploying your contract, verify it to make your contract's source code publicly available:
  ...
  cards={[
    {
      title: "Foundry",
      icon: "/img/getting-started/foundry-logo.png",
      description: "Verify Smart Contract on Flare using Foundry",
      link: "/network/guides/hardhat-foundry-starter-kit#foundry",
    },
    {
      title: "Hardhat",
      icon: "/img/getting-started/hardhat-logo.svg",
      description: "Verify Smart Contract on Flare using Hardhat",
      link: "/network/guides/hardhat-foundry-starter-kit#hardhat",
    },
  ]}
/>

## Tutorial: Deploy with Remix {#tutorial}

You can deploy your first smart contract and run it in your browser without prior knowledge of Flare. This guide demonstrates how easy it is to develop smart contracts using the [Solidity language](https://soliditylang.org/), a [MetaMask wallet](https://metamask.io/) and the [Remix Development Environment](https://remix.ethereum.org/).
...
2. **Compile:** Convert your human-readable smart contract code into bytecode.
3. **Deploy:** Send the compiled smart contract to the blockchain.
4. **Call functions:** Execute the functions defined in your contract.
