...
import ConnectWallet from "@site/src/components/ConnectWallet";
...
To interact with the Flare network, you'll need to connect your wallet and configure it for Flare networks.
