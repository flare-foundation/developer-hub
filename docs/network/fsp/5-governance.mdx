...
STPs allow rapid testing of proposals on Songbird before their implementation on Flare Mainnet.
...
1. **Proposal Announcement:** The Flare Foundation publishes proposals on the [Flare governance portal](https://proposals.flare.network/), the Flare website and social media (see footer for links).
