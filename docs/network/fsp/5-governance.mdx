...
The [FIP.2](https://proposals.flare.network/FIP/FIP_2.html) governance proposal introduced a Management Group of data providers, whose initial role was to:

- Report any instances of **collusion** within the FTSO protocol.
- Collectively determine through voting whether punitive actions, such as **chilling** or **banning**, should be taken.

Data providers that are part of the Management Group must be actively participating in the core protocols and be eligible for rewards, while not have been punished recently.

Through the adoption of [FIP.08](https://proposals.flare.network/FIP/FIP_8.html) and [FIP.11](https://proposals.flare.network/FIP/FIP_11.html), the role of the Management Group was extended as follows:

- Voting on adding new feeds to the FTSO protocol.
