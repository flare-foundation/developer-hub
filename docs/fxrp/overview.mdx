...
On **Flare Testnet Coston2**, you can testnet FXRP directly from the [Coston2 Faucet](https://faucet.flare.network/coston2) — no minting required.
This is the fastest way to start testing FAssets integrations.
...
For complete code examples and step-by-step instructions, see the [FAssets minting guide](/fassets/developer-guides/fassets-direct-minting).

**What can go wrong:** Before sending XRP, validate the Core Vault address, minimum fee, and recipient encoding.
See [Direct Minting Troubleshooting](/fassets/troubleshooting/direct-minting-troubleshooting#before-you-send-xrp) for a pre-flight checklist and error tables.
