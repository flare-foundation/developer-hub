...
- Learn how to [get Firelight vault status](/fxrp/firelight/status) to monitor your position.
- Learn how to [deposit assets into a Firelight vault](/fxrp/firelight/deposit) by specifying the amount of assets to deposit.
