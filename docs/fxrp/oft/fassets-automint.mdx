...
The [`FXRPCollateralReservationInstruction`](/smart-accounts/fasset-instructions#00-collateral-reservation) is a predefined instruction type that initiates the FAsset minting process.
...
- Learn how to [mint FXRP manually](/fassets/developer-guides/fassets-direct-minting)
