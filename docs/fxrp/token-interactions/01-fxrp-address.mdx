...
import RedemptionProcessPrerequisites from "../../fassets/developer-guides/_redemption_process_prerequisites.mdx";
import GetFXRPAssetManager from "../../fassets/developer-guides/_get_fxrp_asset_manager.mdx";
