...
- See an FCC + x402 composition in the [weather insurance AI agent showcase](https://github.com/flare-foundation/fce-weather-insurance-x402-agent) (built on the [Weather Insurance Extension](/fcc/guides/weather-insurance-extension)).
