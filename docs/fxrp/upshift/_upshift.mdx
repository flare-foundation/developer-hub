...
The [Upshift vault](https://app.upshift.finance/pools/14/0x373D7d201C8134D4a2f7b5c63560da217e3dEA28) is part of the XRP finance stack on Flare Network.
The example scripts in the guides below interact with the Coston2 testnet [vault](https://coston2-explorer.flare.network/address/0x24c1a47cD5e8473b64EAB2a94515a196E10C7C81).
...
<DocCardList
  items={[
    ...
    },
    {
      type: "link",
      label: "Claim",
      href: "/fxrp/upshift/claim",
      docId: "fxrp/upshift/claim",
    },
  ]}
/>
