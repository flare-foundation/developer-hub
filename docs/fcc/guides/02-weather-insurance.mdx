...
For an AI agent that buys and settles policies with [x402 payments](/fxrp/token-interactions/x402-payments) on top of this extension, see the [Weather Insurance with x402 payments showcase](https://github.com/flare-foundation/fce-weather-insurance-x402-agent).
...
Explore the [AI agent + x402 showcase](https://github.com/flare-foundation/fce-weather-insurance-x402-agent) built on this extension.
:::
