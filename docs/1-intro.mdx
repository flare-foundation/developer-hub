...
<div className="row">
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      item={{
        type: "link",
        label: "Deploy your first Flare contract",
...
| **Chain ID** | `14`                                                             | `114`                                                                            |
| **Explorer** | [`https://mainnet.flarescan.com`](https://mainnet.flarescan.com) | [`https://coston2.testnet.flarescan.com`](https://coston2.testnet.flarescan.com) |
  ...
  <div className="col col--3 margin-bottom--lg">
    <DocCard
      item={{
        ...
        description:
          "Turnkey, Wagmi, Web3Auth, RainbowKit, Etherspot, {Safe}Wallet",
        docId: undefined,
      }}
    />
  </div>
  <div className="col col--3 margin-bottom--lg">
    <DocCard
      item={{
        ...
        description: "LayerZero, Stargate, OFTs, zkBridge",
        docId: undefined,
      }}
    />
  </div>
