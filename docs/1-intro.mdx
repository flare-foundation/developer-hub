...
| :----------- | :------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------- |
| **RPC**      | `https://flare-api.flare.network/ext/C/rpc` <br/> `https://stylish-light-theorem.flare-mainnet.quiknode.pro/ext/bc/C/rpc` | `https://coston2-api.flare.network/ext/C/rpc` <br/> `https://falling-skilled-uranium.flare-coston2.quiknode.pro/ext/bc/C/rpc` |
| **Chain ID** | `14`                                                                                                                      | `114`                                                                                                                         |
