...
- [Learn how to use FTSOv2](./ftso/overview) — Leverage the latest upgrades to the Flare Time Series Oracle, where feeds now update every ≈1.8 seconds, over 90x faster than FTSOv1.
