...
Connect using these network configurations:
...
Build faster with developer tooling from Flare's ecosystem.
  ...
  <div className="col col--6 margin-bottom--lg">
    <DocCard
      item={{
        ...
        description: "Build the future of Verifiable AI on Flare.",
        docId: undefined,
      }}
    />
  </div>
